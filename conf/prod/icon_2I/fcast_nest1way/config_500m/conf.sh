...
PARENTMODEL=ICON
PARENTMODEL_ARKI_DS=$WORKDIR_BASE/arkimet/icon_icbc1V1ecotuoff
#PARENTMODEL_SIGNAL=hres_am_foricon
PARENTMODEL_FREQINI=6
PARENTMODEL_FREQANA=6
PARENTMODEL_FREQFC=1
#Il parent model in questo caso è : icbc1V1ecotuoff
PARENTMODEL_DOMAIN=Nest500_from_OPE2km_to_EM500m_v1
PARENTMODEL_STATIC=$MODEL_STATIC/domain_$PARENTMODEL_DOMAIN
PARENTMODEL_GRIDFILE=${PARENTMODEL_DOMAIN}_DOM02.nc 
PARENTMODEL_STATICFILE=${PARENTMODEL_DOMAIN}_DOM02_external_parameter.nc 



# ICON-2I domain and grid files #LUDO
DOMAIN=Nest500_from_OPE2km_to_EM500m_v1
LOCALGRID=$MODEL_STATIC/domain_$DOMAIN/${DOMAIN}_DOM03.nc
LOCALGRID_PARENT=$MODEL_STATIC/domain_$DOMAIN/${DOMAIN}_DOM02.nc
LOCALGRID_EXTERNAL=$MODEL_STATIC/domain_$DOMAIN/${DOMAIN}_DOM03_external_parameter.nc

# Time step 5 per 500m
TIME_STEP=5
