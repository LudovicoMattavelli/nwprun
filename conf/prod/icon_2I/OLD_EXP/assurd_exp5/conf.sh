...
DOMAIN=Nest5_2OPE_1NIv2_500EMv2_250FEv1_125FEv1_GLBC
LOCALGRID=$MODEL_STATIC/domain_$DOMAIN/data/DOM04/${DOMAIN}_DOM04.nc
LOCALGRID_PARENT=$MODEL_STATIC/domain_$DOMAIN/data/DOM03/${DOMAIN}_DOM03.nc
LOCALGRID_EXTERNAL=$MODEL_STATIC/domain_$DOMAIN/data/DOM04/${DOMAIN}_DOM04_external_parameter.nc
